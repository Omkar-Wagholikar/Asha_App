...
"""
import json
data = temp.replace("'", '"').replace("<Answer ", "").replace("<Document:", "").replace(">", "")
file_path = "op.json"
...
# # Define the analyzer and text for analysis
# analyzer = "standard"  # Replace with your custom analyzer if needed
# text = "Elasticsearch is a powerful tool for searching and analyzing data."

# # Use the _analyze API to get the tokens
# tokens = es.indices.analyze(body={"analyzer": analyzer, "text": text})
